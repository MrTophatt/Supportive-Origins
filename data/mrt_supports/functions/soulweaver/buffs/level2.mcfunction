...
execute as @e[type=armor_stand,tag=linked] if score @s soulLinkID = #temp soulLinkID run power grant @s mrt_supports:soulweaver/helpers/buffs/level2
power grant @s mrt_supports:soulweaver/helpers/buffs/level2